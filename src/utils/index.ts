...
export const getToothGeometry = (
  ...
  switch (toothType) {
    case "incisor":
      return new BoxGeometry(size * 0.6, size * 1.2, size * 0.4);
    case "canine":
      return new ConeGeometry(size * 0.3, size * 1.4, 8);
    case "premolar":
      return new CylinderGeometry(size * 0.4, size * 0.4, size * 0.8, 8);
    case "molar":
      return new BoxGeometry(size * 0.8, size * 0.8, size * 0.6);
    default:
      return new BoxGeometry(size * 0.6, size * 1.0, size * 0.4);
  }
};
